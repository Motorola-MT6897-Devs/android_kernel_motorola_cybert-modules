...
static void lcm_panel_init(struct lcm *ctx)
{
	...
	if(ctx->version < 3) {
		lcm_dcs_write_seq_static(ctx, 0xB1, 0x01,0x9C,0x00,0x14,0x00,0x34,0x00,0x01,0x9C,0x00,0x14,0x03,0xD4,0x00,0x01,0x9C,0x00,0x14,0x0B,0x14,0x00,0x01,0x9C,0x00,0x14,0x10,0x84,0x00);
		lcm_dcs_write_seq_static(ctx, 0xB2, 0x01,0x9C,0x00,0x14,0x00,0x34,0x03,0x01,0x9C,0x00,0x14,0x00,0x34,0x03,0x01,0x9C,0x00,0x14,0x00,0x34,0x03);
		//source porch
		lcm_dcs_write_seq_static(ctx, 0xC4, 0xB8,0x00,0xB8,0x00,0xB8,0x00,0xF8,0x00,0x0F);
		lcm_dcs_write_seq_static(ctx, 0x65, 0x0A);
		lcm_dcs_write_seq_static(ctx, 0xC4, 0xB8,0x00,0xB8,0x00,0xB8,0x00,0x07);
		lcm_dcs_write_seq_static(ctx, 0xD0, 0x84,0x68,0x22,0x22,0x84,0x1F,0x40,0x14,0x66,0x66,0x20,0x00,0x05,0x14,0x14,0x66,0x66,0x20,0x00);
		lcm_dcs_write_seq_static(ctx, 0xD1, 0x00,0x39,0x16,0x16,0x16,0x16,0x0B,0x00,0x00,0x19,0x00,0x00,0x00,0x00,0x34,0x0B,0x19,0x00,0x00,0x00,0x00,0x29,0x0A,0x0A,0x0A,0x0A,0x2C,0x00,0x00,0x32,0x00,0x00,0x00,0x00,0x28,0x2C,0x32,0x00,0x00,0x00,0x00);

		//charge pump
		lcm_dcs_write_seq_static(ctx, 0xF0, 0xAA,0x12);
		lcm_dcs_write_seq_static(ctx, 0xB1, 0xFF,0xFF,0xFF,0x33);
		lcm_dcs_write_seq_static(ctx, 0xD6, 0x04,0x00);

		//Emit EQ
		lcm_dcs_write_seq_static(ctx, 0xF0, 0xAA,0x14);
		lcm_dcs_write_seq_static(ctx, 0xB0, 0x00,0x00,0x00,0x30,0x00,0x00,0x11,0x11,0x11,0x11,0x11,0x11,0x11,0x11,0x11,0x11,0x11,0x11,0x11,0x11,0x11,0x11);
		lcm_dcs_write_seq_static(ctx, 0x65, 0x16);
		lcm_dcs_write_seq_static(ctx, 0xB0, 0x11,0x11,0x11,0x11,0x11,0x11,0x11,0x11,0x11,0x11,0x11,0x11);

		//MUX
		lcm_dcs_write_seq_static(ctx, 0xf0, 0xaa, 0x16);
		lcm_dcs_write_seq_static(ctx, 0xC4, 0xFF,0xFF,0xFF,0x0F,0xFF,0xFF,0xFF,0xFF,0x0F);
		lcm_dcs_write_seq_static(ctx, 0xd1, 0x00,0x01,0x00,0x00,0x01,0x00,0x00,0x01,0x00,0x00,0x01,0x00,0x00,0x00,0x00,0x00);
	} else if(ctx->version == 3) {
		lcm_dcs_write_seq_static(ctx, 0xB1, 0x01,0x9C,0x00,0x14,0x00,0x34,0x00,0x01,0x9C,0x00,0x14,0x03,0xD4,0x00,0x01,0x9C,0x00,0x14,0x0B,0x14,0x00,0x01,0x9C,0x00,0x14,0x00,0x34,0x00);
		lcm_dcs_write_seq_static(ctx, 0xB2, 0x01,0x9C,0x00,0x14,0x00,0x34,0x03,0x01,0x9C,0x00,0x14,0x00,0x34,0x03,0x01,0x9C,0x00,0x14,0x00,0x34,0x03);
		lcm_dcs_write_seq_static(ctx, 0xD0, 0x84,0x68,0x22,0x22,0x84,0x1F,0x40,0x14,0x66,0x66,0x20,0x00,0x05,0x14,0x14,0x66,0x66,0x20,0x00);
		...
		lcm_dcs_write_seq_static(ctx, 0xB1, 0x01,0x9C,0x00,0x14,0x00,0x34,0x00,0x01,0x9C,0x00,0x14,0x03,0xD4,0x00,0x01,0x9C,0x00,0x14,0x0B,0x14,0x00);
		lcm_dcs_write_seq_static(ctx, 0xB2, 0x01,0x9C,0x00,0x14,0x00,0x34,0x03,0x01,0x9C,0x00,0x14,0x00,0x34,0x03,0x01,0x9C,0x00,0x14,0x00,0x34,0x03);
	...
	lcm_dcs_write_seq_static(ctx, 0xE7, 0x7F);
	lcm_dcs_write_seq_static(ctx, 0x65, 0x08);
	lcm_dcs_write_seq_static(ctx, 0xE7, 0x00,0x0E,0x02,0x02);
	lcm_dcs_write_seq_static(ctx, 0x65, 0x0E);
	lcm_dcs_write_seq_static(ctx, 0xE7, 0x08,0x01);

	if(ctx->version == 3) {
		lcm_dcs_write_seq_static(ctx, 0xF0,0xAA,0x1C);
		lcm_dcs_write_seq_static(ctx, 0xB0,0x01,0x00,0x3E,0x81,0xED,0x63,0x75,0x4C,0x4C,0x4E,0x4F);
	}
...
static struct mtk_panel_params ext_params_48hz = {
	...
	.dyn_fps = {
		.switch_en = 0,
		.vact_timing_fps = 120,
		.dfps_cmd_grp_table[0] = {2, {0x6c, 0x03} },
		.dfps_cmd_grp_size = 1,
	},
